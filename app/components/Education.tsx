  ...
  const education = [
    {
      ...
      period: "2020 - 2024",
      achievements: [
        "Graduated with a CGPA of 3.70",
        "Specialized in Web Technologies and Artificial Intelligence",
        "Completed a final year project on Investor and entrepreneur Recommendation System",
      ],
    },
  ]
          ...
          {education.map((edu, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                <h3 className="text-2xl  font-chakra mb-2 dark:text-white flex items-center">
                ...
                <h4 className="text-lg  font-chakra mb-2 dark:text-gray-200 flex items-center">
                  <Award className="w-5 h-5 mr-2" />
                  Key Achievements:
                </h4>
                <ul className="list-disc  font-chakra list-inside space-y-2">
